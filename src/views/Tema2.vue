...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    TabsC.color-primario.mb-5
      .py-3.py-md-4(titulo="Comprender a la otra persona")
        .row.align-items-center.justify-content-center
          ...
          .col-lg-5
            figure
              img(src='@/assets/curso/tema2/img8.png', style="width: 450px")
      .py-3.py-md-4(titulo="Demostrarle comprensión")
        .row.align-items-center.justify-content-center
          .col-lg-5.mb-4.mb-md-0
          ...
          .col-lg-5
            figure
              img(src='@/assets/curso/tema2/img9.png', style="width: 450px")
    .separador
    #t_2_2.pt-5
    .titulo-segundo.color-acento-contenido
            ...
            .col-12
              .p-4
                .row.align-items-center
                  ...
                  .col
                    p #[span.txt-deco1 Contexto:] recursos adecuados, liderazgo y estructura, clima de confianza, evaluación del desempeño y sistemas de recompensa.
          .row.bg-color1.rounded.mb-4
            .col-12
              .p-4
                .row.align-items-center
                  ...
                  .col
                    p #[span.txt-deco1 Composición:] aptitudes de los miembros, personalidad, asignación de roles, diversidad, tamaño de los equipos, flexibilidad y preferencias de los miembros.
          .row.bg-color1.rounded.mb-4
            .col-12
              .p-4
                .row.align-items-center
                  .col-auto
                    figure
                      img(src='@/assets/curso/tema2/img20.svg', style="width: 100px").m-auto
                  .col
                    p #[span.txt-deco1 Diseño del trabajo:] autonomía, variedad de aptitudes, identidad y significancia de la tarea.
            ...
            .col-12
              .p-4
                .row.align-items-center
                  .col-auto
                    figure
                      img(src='@/assets/curso/tema2/img21.svg', style="width: 100px").m-auto
                  .col
                    p #[span.txt-deco1 Proceso:] propósito común, metas específicas, eficacia del equipo, niveles de conflicto, pereza social.
        .row
          .col-12.bg-color8
            .p-2
              p.mb-0 Nota: adaptado de Robbins (2009).
      ...
      .col-12.p-5
        ...
        SlyderF(columnas="col-lg-6 col-xl-4")
          ...
          .tarjeta.color-acento-4.p-5
            ...
            h2.text-center Escucha
            p.text-center.mb-0 Atenta y respetuosa: esperar que el cliente diga todo lo que tiene por decir sin interrumpir.
...
export default {
  ...
  data: () => ({
    datosSlyder: [
      ...
      {
        titulo: 'Establecimiento de normas',
        texto:
