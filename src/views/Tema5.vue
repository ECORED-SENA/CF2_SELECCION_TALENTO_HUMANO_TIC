  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.bg-color14
      .col-12.px-5
        ...
        .tarjeta.tarjeta--azul.p-3.p-lg-5.mb-5(data-aos="fade-left")
          SlyderA(tipo="b")
            ...
            .row.align-items-center.justify-content-center
              .col-lg-7.mb-4.mb-md-0
                P.txt-deco1.mb-3 Observación
                p Se basa en hacer un seguimiento continuo al personal y plataformas digitales que tienen comunicación directa con el cliente para ver como lo están haciendo y retroalimentar las acciones de mejora. En caso de las personas brindar las correcciones de forma motivadora.
              .col-lg-4
                figure.mt-4
                  img(src='@/assets/curso/tema5/img3.png', style="width: 650px").m-auto
            .row.align-items-center.justify-content-center
              .col-lg-7.mb-4.mb-md-0
                P.txt-deco1.mb-3 Cliente incógnito
                p Se emplea una persona para que haga uso de las plataformas o visite los puntos de venta sin que los funcionarios lo sepan, haciendo compras, recibiendo la atención y servicio común y corriente para después informar al área encargada de la atención, cuál es la experiencia como cliente que se está recibiendo para que el área tome acciones de mejora.
              .col-lg-4
                figure.mt-4
                  img(src='@/assets/curso/tema5/img4.png', style="width: 650px").m-auto
            .row.align-items-center.justify-content-center
              .col-lg-7.mb-4.mb-md-0
                P.txt-deco1.mb-3 Monitoreo de canales de comunicación
                p Se hace seguimiento a correos electrónicos, redes sociales, comentarios publicados, call center y demás que maneje la organización para mejorar o responder inquietudes según corresponda.
              .col-lg-4
                figure.mt-4
        ...
        .row.align-items-center.mb-5(data-aos="fade-up-right")
        ...
        .row.justify-content-center(data-aos="fade-left")
          .col-lg-8.mb-4
            ...
            figure
              img(src='@/assets/curso/tema5/img6.svg', style="width: 800px").m-auto
